        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="order-1 lg:order-2 text-center lg:text-left pt-8 pb-12">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <div className="group bg-gray-900/50 backdrop-blur-sm p-6 rounded-xl border border-gray-700 hover:border-brand-accent transition-all duration-300 card-hover">
