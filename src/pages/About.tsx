          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="bg-gray-900/50 p-8 rounded-xl border border-gray-700">
              ...
              <div className="text-center">
                <h3 className="text-xl font-bold text-brand-white mb-2">{t('about.story.approach.title')}</h3>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-12">
            <div className="text-center">
              ...
              <h2 className="text-2xl md:text-3xl font-bold text-brand-white mb-6">{t('about.mission.title')}</h2>
            ...
            <div className="text-center">
              ...
              <h2 className="text-2xl md:text-3xl font-bold text-brand-white mb-6">{t('about.vision.title')}</h2>
              <p className="text-gray-300 text-lg leading-relaxed">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            <div className="bg-gray-900/50 p-6 rounded-xl border border-gray-700 text-center card-hover">
              ...
              />
              <h3 className="text-lg font-bold text-brand-white mb-2">{t('about.team.members.alex.name')}</h3>
              <p className="text-brand-accent font-medium mb-2">{t('about.team.members.alex.role')}</p>
            ...
            <div className="bg-gray-900/50 p-6 rounded-xl border border-gray-700 text-center card-hover">
              <img 
                ...
                className="w-24 h-24 rounded-full mx-auto mb-4 object-cover"
              />
              <h3 className="text-lg font-bold text-brand-white mb-2">{t('about.team.members.sarah.name')}</h3>
              <p className="text-brand-accent font-medium mb-2">{t('about.team.members.sarah.role')}</p>
              <p className="text-gray-300 text-sm">
            ...
            <div className="bg-gray-900/50 p-6 rounded-xl border border-gray-700 text-center card-hover">
              <img 
                ...
                className="w-24 h-24 rounded-full mx-auto mb-4 object-cover"
              />
              <h3 className="text-lg font-bold text-brand-white mb-2">{t('about.team.members.marcus.name')}</h3>
              <p className="text-brand-accent font-medium mb-2">{t('about.team.members.marcus.role')}</p>
              <p className="text-gray-300 text-sm">
